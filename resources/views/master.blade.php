...
<div style="text-align: right">
    <a href="{{route('get.login')}}">
        <img src="/images/login.jpg" style="width: 100px">
    </a>
</div>
...
<div class="row">
    <div class="col-xl-2">
        ...
        <a href="{{route('roles.index')}}">
            <button type="button" class="btn btn-outline-success" style="width: 100%">ROLE LIST</button>
        </a>
        <a href="{{route('categories.index')}}">
            <button type="button" class="btn btn-outline-success" style="width: 100%">CATEGORIES LIST</button>
        </a>
        <a href="{{route('books.index')}}">
            <button type="button" class="btn btn-outline-success" style="width: 100%">BOOKS LIST</button>
        </a>
